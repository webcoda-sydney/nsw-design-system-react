 ...
 *
 * @param  {string}   siteTitle        - Main site title
 * @param  {string}   siteDescriptor   - Optional additional descriptor
 * @param  {string}   logo             - Location of the co-brand logo file
...
export class Header extends React.Component {
  constructor(props) {
    ...
    this.refOpenSearchButton = React.createRef()
    this.refCloseSearchButton = React.createRef()
  }

  async componentDidMount() {
    const { SiteSearch } = await import('nsw-design-system/src/main')
    if (this.search) {
      new SiteSearch(this.refOpenSearchButton.current).init()
      new SiteSearch(this.refCloseSearchButton.current).init()
    }
  }
              ...
              <div className='nsw-header__main'>
                ...
                {this.logo ? (
                  <div className='nsw-header__name'>
                    <img src={this.logo} alt={this.siteTitle + 'logo'} />
                    <span className='sr-only'>{this.siteTitle}</span>
                    <span className='sr-only'>{this.siteDescriptor}</span>
                  </div>
                ) : (
                  <div className='nsw-header__name'>
                    <div className='nsw-header__title'>{this.siteTitle}</div>
